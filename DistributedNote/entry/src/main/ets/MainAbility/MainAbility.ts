...
export default class MainAbility extends UIAbility {
  onCreate(want, launchParam): void {
    ...
    AppStorage.SetOrCreate('readerModel', new DistributedReaderModel());
  }
  ...
  onWindowStageCreate(windowStage): void {
    ...
    windowStage.setUIContent(this.context, 'pages/SplashPage', null);
  }
  ...
  onNewWant(want): void {
    ...
    let readerModel = <DistributedObjectModel> AppStorage.Get('readerModel');
    readerModel.off();
    AppStorage.SetOrCreate('readerModel', new DistributedReaderModel());
  }
}
